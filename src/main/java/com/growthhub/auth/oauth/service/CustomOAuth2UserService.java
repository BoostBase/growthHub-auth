package com.growthhub.auth.oauth.service;
...
import com.growthhub.auth.oauth.dto.response.OAuthAttributes;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        Provider socialType = getProvider(registrationId);
        ...
        User createdUser = getOrGenerateUser(extractAttributes); // User 객체 생성 후 반환 or 존재하는 유저 반환
